...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addons.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateProfile = exports.submitTask = exports.submitProject = exports.createTask = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('login_success', 'New Task Updated');
...
var submitTask = exports.submitTask = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('login_success', 'Task updated Successfully');
            location.reload(true);
          }
          _context3.next = 11;
          break;
        case 8:
          _context3.prev = 8;
          _context3.t0 = _context3["catch"](0);
          (0, _alerts.showAlert)('login_failure', 'Cannot Submit Task');
        case 11:
        case "end":
          return _context3.stop();
      }
  ...
  return function submitTask(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
var submitProject = exports.submitProject = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          res = _context4.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('login_success', 'Project updated Successfully');
            location.reload(true);
          }
          _context4.next = 11;
          break;
        case 8:
          ...
          (0, _alerts.showAlert)('login_failure', 'Cannot Submit Project');
        case 11:
        case "end":
  ...
  return function submitProject(_x4) {
...
var userDataForm = document.querySelector('.save .btn__save');
var logoutBtn = document.querySelector('.logout');
var projectSelect = document.querySelector('.projectSelect');
var createTaskBtn = document.querySelector('.create_btn');
var userCards = document.querySelectorAll('.usermng_card');
var signupForm = document.querySelector('.signup__form');
var tasklistCards = document.querySelectorAll('.tasklist__card');
var projectlistCards = document.querySelectorAll('.project__card');
var workSubmitBtn = document.querySelector('.user_fsubmit');
var projectSubmitBtn = document.querySelector('.user_psubmit');
...
if (userDataForm) {
  userDataForm.addEventListener('click', function (e) {
    e.preventDefault();
    ...
    (0, _addons.updateProfile)(form, 'data');
  });
}
if (logoutBtn) {
...
if (projectSelect) {
  ...
  projectSelect.addEventListener('change', function (e) {
    ...
    location.assign("/projectmanagement/".concat(projectSelect.value));
  });
}
if (createTaskBtn) {
  createTaskBtn.addEventListener('click', function (e) {
    var projectMenu = document.querySelector('.project_menu');
    projectMenu.style.width = 'calc(100% - (240px + 10rem))';
    var createTaskForm = document.querySelector('.new_task_data');
...
if (userCards) {
  userCards.forEach(function (el) {
    el.addEventListener('click', function (e) {
      //   console.log(el.dataset.userId);
      location.assign("/userManagement/".concat(el.dataset.userId));
    });
  });
}
if (signupForm) {
...
if (tasklistCards) {
  ...
  tasklistCards.forEach(function (el) {
    el.addEventListener('click', function (e) {
      if (el.dataset.taskId) location.assign("/tasks/".concat(el.dataset.taskId));else location.assign("/tasks/".concat(el.dataset.projectId));
    });
  });
}
if (projectlistCards) {
  //   console.log('cards available');
  projectlistCards.forEach(function (el) {
    el.addEventListener('click', function (e) {
      if (el.dataset.taskId) location.assign("/tasks/".concat(el.dataset.projectId));else location.assign("/tasks/".concat(el.dataset.projectId));
    });
  });
}
if (workSubmitBtn) {
...
if (projectSubmitBtn) {
  projectSubmitBtn.addEventListener('click', function (e) {
    ...
    (0, _addons.submitProject)(projectId);
  });
}
},{"./login":"login.js","./addons":"addons.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
